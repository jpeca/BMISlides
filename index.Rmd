...
BMI <- function(m,h) round(m*10000/as.double(h*h), digits=0)
#Calculate category for body mass index
catBMI <- function (bmi) {
  if (bmi < 18.5 ) "Underweight"
  else if (bmi >= 35) "Overweight - Sevelrly Obese"
  else if (bmi <25) "Normal"
  else if (bmi <30) "Overweight - At Risk"
  else if (bmi <35) "Overweight - Modelatly Obese"
}
